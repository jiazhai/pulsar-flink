...
public class FlinkPulsarSource<T>
    ...
    public void run(SourceContext<T> ctx) throws Exception {
        ...
        this.successfulCommits =
                this.getRuntimeContext().getMetricGroup().counter(PulsarSourceMetrics.COMMITS_SUCCEEDED_METRICS_COUNTER);
        this.failedCommits =
                this.getRuntimeContext().getMetricGroup().counter(PulsarSourceMetrics.COMMITS_FAILED_METRICS_COUNTER);
